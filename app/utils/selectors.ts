...
export const getPrefix = async (page: Page) => {
  ...
  await page.evaluate((el, value) => (el as any).value = value, elm, 'Prefer not to identify');
  return elm;
};
...
export const getFirstName = async (page: Page, name: string) => {
  ...
  await page.evaluate((el, value) => (el as any).value = value, elm, name);
  return elm;
};
...
export const getStreetAddressOne = async (page: Page, address: string) => {
  ...
  await page.evaluate((el, value) => (el as any).value = value, elm, address);
  return elm;
};
...
export const getCity = async (page: Page, city: string) => {
  ...
  await page.evaluate((el, value) => (el as any).value = value, elm, city);
  return elm;
};
...
export const getState = async (page: Page, state: string) => {
  ...
  await page.evaluate((el, value) => (el as any).value = value, elm, state);
  return elm;
};
...
export const getZipCode = async (page: Page, zipCode: string) => {
  ...
  await page.evaluate((el, value) => (el as any).value = value, elm, zipCode);
  return elm;
};
...
export const getPhoneNumber = async (page: Page, phoneNumber: string) => {
  ...
  await page.evaluate((el, value) => (el as any).value = value, elm, phoneNumber);
  return elm;
};
...
export const getEmailInput = async (page: Page, email: string) => {
  ...
  const elm = Array.from(input)[0];
  await page.evaluate((el, value) => (el as any).value = value, elm, email);
  return elm;
};
...
export const getSubjectInput = async (page: Page, subject: string) => {
  ...
  await page.evaluate((el, value) => (el as any).value = value, elm, subject);
  return elm;
};
...
export const getMessageTopic = async (page: Page) => {
  ...
  await page.evaluate((el, value) => (el as any).value = value, elm, 'FP');
  return elm;
};
...
export const getMessage = async (page: Page, message: string) => {
  ...
  await page.evaluate((el, value) => (el as any).value = value, textarea, message);
  return textarea;  
}; 
